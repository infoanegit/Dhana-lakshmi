<cfoutput>
    ...
    <html>
        <head>
            ...
            <style>
                .bg{
                    background-image: url('./assets/IMAGES/bgorm.jpg');
                        ...
                        <center>
                            <div class="mt-3">
                                <div class="form-group w-25 mt-3 ">
                                    ...
                                    <input type="text" class="form-control" id="empname" name="empname" placeholder="enter your name">
                                </div>
                                <div class="form-group w-25 mt-3">
                                    <label for="empage" class="label"><h4 style="color:white;">Employee age</h4></label>
                                    <input type="text" class="form-control" id="empage" name="empage" placeholder="enter your age">
                                </div>
